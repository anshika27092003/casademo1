...
class CKSecreterial(Base):
    ...
    consignment_number = Column(String, nullable=True) # Registration Number
    invoice_date = Column(String, nullable=True)
    invoice_no = Column(String, nullable=True)
    bill_to = Column(String, nullable=True)
    sub_total = Column(String, nullable=True)
    gst_amount = Column(String, nullable=True) # GST 9%
    total_amount = Column(String)
    remarks = Column(String, nullable=True) # Description
    timestamp = Column(DateTime, default=datetime.utcnow)
